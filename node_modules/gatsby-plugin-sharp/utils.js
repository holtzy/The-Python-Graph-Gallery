...
function fixedImageSizes({
  ...
  sizes = densities.filter(size => size >= 1) // remove smaller densities because fixed images don't need them
...
function fluidImageSizes({
  ...
  let isTopSizeOverriden = imgDimensions.width < maxWidth || imgDimensions.height < maxHeight;
