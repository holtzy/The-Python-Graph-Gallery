...
import { AbstractPureComponent2, IPopoverProps, ITagInputProps } from "@blueprintjs/core";
...
export declare class MultiSelect<T> extends AbstractPureComponent2<IMultiSelectProps<T>, IMultiSelectState> {
    static displayName: string;
    static defaultProps: {
        fill: boolean;
        placeholder: string;
    };
    static ofType<U>(): new (props: IMultiSelectProps<U>) => MultiSelect<U>;
