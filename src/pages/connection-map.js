  ...
  return (
    ...
    <Layout title="Connection Map" isTocEnabled seoDescription="A collection of connection map examples made with Python, coming with explanation and reproducible code">
      ...
      <Container>
        ...
        <p>
          <code>Basemap</code> is probably the best option to draw a connection map with <code>python</code>.
          It provides a function called
          <code>drawgreatcircle()</code> that draws the connection using great circles. Great circles are
          arcs that gives a better appearance than straight lines.
        </p>
        <Row>
          <ChartImageContainer
        ...
        <br /><br />
        <p>This is the result when you visualize the connection between 7 major world cities:</p>
        <div style={{ margin: "0 auto" }}>
          <Link to='/300-draw-a-connection-line'>
            <ChartImage imgName={'300-draw-a-connection-line3'} caption={'A connection map between 7 cities made with Python and Basemap'} />
          </Link>
        </div>
        <Link to="/300-draw-a-connection-line">
